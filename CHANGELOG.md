...
### [v0.5.11](https://github.com/decodelabs/exemplar/commits/v0.5.11) - 11th November 2025

- Improved doc comment headers
- Don't flush output memory on Writer::__toString()

[Full list of changes](https://github.com/decodelabs/exemplar/compare/v0.5.10...v0.5.11)

---

### [v0.5.10](https://github.com/decodelabs/exemplar/commits/v0.5.10) - 3rd October 2025

- Upgraded Nuance to v0.2
- Simplified CI workflow

[Full list of changes](https://github.com/decodelabs/exemplar/compare/v0.5.9...v0.5.10)
...
### [v0.5.8](https://github.com/decodelabs/exemplar/commits/v0.5.8) - 16th July 2025

- Applied ECS formatting to all code

[Full list of changes](https://github.com/decodelabs/exemplar/compare/v0.5.7...v0.5.8)
